    ...
    try:
        ...
        if kline and isinstance(kline, dict):
            if is_new_kline(kline):
                ...
                #data will be appended to appropriate list for the correct symbols.
                all_data[symbol].append([timestamp, open, high, low, close, volume])
                recent_klines[symbol] = all_data[symbol][-(window_width*3):]
